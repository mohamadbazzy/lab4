...
class DatabaseApp(tk.Tk):
    ...
    def __init__(self):
        ...
        # Create different tabs for various functions
        ...
        self.tabs.add(self.add_student_tab, text='Add Student')
        self.tabs.add(self.add_instructor_tab, text='Add Instructor')
